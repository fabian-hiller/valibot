...
import { partialBy } from './partialBy.ts';
...
describe('partialBy', () => {
  ...
  describe('object', () => {
    ...
    const schema1 = partialBy(wrapped, optional);
    const schema2 = partialBy(wrapped, optional, ['key1', 'key3']);
  ...
  describe('objectWithRest', () => {
    ...
    const schema1 = partialBy(wrapped, optional);
    const schema2 = partialBy(wrapped, optional, ['key2', 'key3']);
