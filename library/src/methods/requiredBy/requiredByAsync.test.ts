...
import { requiredByAsync } from './requiredByAsync.ts';
...
describe('requiredByAsync', () => {
  ...
  describe('objectAsync', () => {
    ...
    const schema1 = requiredByAsync(wrapped, nonOptionalAsync);
    const schema2 = requiredByAsync(wrapped, nonOptionalAsync, [
      'key1',
      'key3',
    ]);
    ...
    describe('should return schema object', () => {
      ...
      test('with undefined keys and string message', () => {
        ...
        const schema = requiredByAsync(wrapped, nonOptionalAsync, message);
