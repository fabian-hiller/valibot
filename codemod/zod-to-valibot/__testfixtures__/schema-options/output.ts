...
const schema7Description = Schema7.pipe[1].description;
const Schema8 = v.pipe(v.literal("hello"), v.description('some description (literal "hello")'));
const schema8Description = Schema8.pipe[1].description;
// coerce
...
const schema14Description = Schema14.pipe[2].description;