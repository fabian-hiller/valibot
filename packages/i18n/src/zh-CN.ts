...
const language: Language = {
  ...
  specific: {
    bic:            (issue) => `无效的商业标识符格式：输入为 ${issue.received}`,
    bytes:          (issue) => `无效的字节长度：预期为 ${issue.expected}，而输入为 ${issue.received}`,
    creditCard:     (issue) => `无效的信用卡格式：输入为 ${issue.received}`,
    cuid2:          (issue) => `无效的 Cuid2 格式：输入为 ${issue.received}`,
    custom:         (issue) => `无效的输入：输入为 ${issue.received}`,
    customAsync:    (issue) => `无效的输入：输入为 ${issue.received}`,
    decimal:        (issue) => `无效的十进制格式：输入为 ${issue.received}`,
    email:          (issue) => `无效的邮箱地址：输入为 ${issue.received}`,
    emoji:          (issue) => `无效的 emoji 格式：输入为 ${issue.received}`,
    ...
    finite:         (issue) => `无效的无限值：输入为 ${issue.received}`,
    hash:           (issue) => `无效的哈希格式：输入为 ${issue.received}`,
    hexColor:       (issue) => `无效的十六进制颜色：输入为 ${issue.received}`,
    hexadecimal:    (issue) => `无效的十六进制格式：输入为 ${issue.received}`,
    ...
    ip:             (issue) => `无效的 IP 格式：输入为 ${issue.received}`,
    ipv4:           (issue) => `无效的 IPv4 格式：输入为 ${issue.received}`,
    ipv6:           (issue) => `无效的 IPv6 格式：输入为 ${issue.received}`,
    isoDate:        (issue) => `无效的日期格式：输入为 ${issue.received}`,
    isoDateTime:    (issue) => `无效的日期-时间格式：输入为 ${issue.received}`,
    isoTime:        (issue) => `无效的时间格式：输入为 ${issue.received}`,
    isoTimeSecond:  (issue) => `无效的含秒时间格式 second：输入为 ${issue.received}`,
    isoTimestamp:   (issue) => `无效的时间戳格式：输入为 ${issue.received}`,
    isoWeek:        (issue) => `无效的周历格式：输入为 ${issue.received}`,
    length:         (issue) => `无效的长度：预期为 ${issue.expected}，而输入为 ${issue.received}`,
    mac:            (issue) => `无效的 MAC 格式：输入为 ${issue.received}`,
    ...
    octal:          (issue) => `无效的八进制格式：输入为 ${issue.received}`,
    ...
    ulid:           (issue) => `无效的 ULID 格式：输入为 ${issue.received}`,
    url:            (issue) => `无效的 URL 格式：输入为 ${issue.received}`,
    uuid:           (issue) => `无效的 UUID 格式：输入为 ${issue.received}`,
