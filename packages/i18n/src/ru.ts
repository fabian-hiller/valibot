...
const language: Language = {
  ...
  specific: {
    ...
    bytes:          (issue) => `Неправильное количество байт: ожидалось ${issue.expected}, получено ${issue.received}`,
    ...
    excludes:       (issue) => `Неправильный исключение: ожидалось ${issue.expected}, получено ${issue.received}`,
    ...
    includes:       (issue) => `Неправильный вхождение: ожидалось ${issue.expected}, получено ${issue.received}`,
    ...
    maxBytes:       (issue) => `Неправильное количество байт: ожидалось ${issue.expected}, получено ${issue.received}`,
    ...
    minBytes:       (issue) => `Неправильное количество байт: ожидалось ${issue.expected}, получено ${issue.received}`,
    ...
    multipleOf:     (issue) => `Неправильное произведение: ожидалось ${issue.expected}, получено ${issue.received}`,
    notBytes:       (issue) => `Неправильное количество байт: ожидалось ${issue.expected}, получено ${issue.received}`,
