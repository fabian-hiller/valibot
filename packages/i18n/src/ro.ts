...
const language: Language = {
  ...
  specific: {
    base64:           (issue) => `Base64 incorect: S-a primit ${issue.received}`,
    ...
    checkItems:       (issue) => `Element incorecte: S-a primit ${issue.received}`,
    checkItemsAsync:  (issue) => `Element incorecte: S-a primit ${issue.received}`,
    ...
    digits:           (issue) => `Cifre incorecte: S-a primit ${issue.received}`,
    ...
    everyItem:        (issue) => `Element incorect: S-a primit ${issue.received}`,
    ...
    graphemes:        (issue) => `Grafeme incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    ...
    maxGraphemes:     (issue) => `Grafeme incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    ...
    maxWords:         (issue) => `Cuvinte incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    ...
    minGraphemes:     (issue) => `Grafeme incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    ...
    minWords:         (issue) => `Cuvinte incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    multipleOf:       (issue) => `Multiplu incorect: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    nanoid:           (issue) => `Nano ID incorect: S-a primit ${issue.received}`,
    ...
    notGraphemes:     (issue) => `Grafeme incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    ...
    notWords:         (issue) => `Cuvinte incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
    octal:            (issue) => `Octal incorect: S-a primit ${issue.received}`,
    partialCheck:     (issue) => `Intrare incorectă: S-a primit ${issue.received}`,
    ...
    someItem:         (issue) => `Element incorect: S-a primit ${issue.received}`,
    ...
    words:            (issue) => `Cuvinte incorecte: Valoarea așteptată era ${issue.expected}, dar s-a primit ${issue.received}`,
  },
};
