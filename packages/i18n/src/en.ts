...
const language: Language = {
	code: "en",
	schema: (issue) =>
		`Invalid type: Expected ${issue.expected} but received ${issue.received}`,
	specific: {
		...
		graphemes: (issue) =>
			`Invalid graphemes: Expected ${issue.expected} but received ${issue.received}`,
		...
		maxWords: (issue) =>
			`Invalid words: Expected ${issue.expected} but received ${issue.received}`,
		mimeType: (issue) =>
