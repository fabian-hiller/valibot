...
const language: Language = {
  ...
  specific: {
    bic: (issue) =>
      `유효하지 않은 사업자 식별코드(BIC): ${issue.received} 을(를) 받았습니다.`,
    bytes: (issue) =>
      `유효하지 않은 바이트: ${issue.expected} 을(를) 예상했으나 ${issue.received} 을(를) 받았습니다.`,
    creditCard: (issue) =>
      `유효하지 않은 신용카드: ${issue.received} 을(를) 받았습니다.`,
    cuid2: (issue) =>
      `유효하지 않은 Cuid2: ${issue.received} 을(를) 받았습니다.`,
    custom: (issue) =>
      `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다.`,
    customAsync: (issue) =>
      `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다.`,
    decimal: (issue) =>
      `유효하지 않은 십진수: ${issue.received} 을(를) 받았습니다.`,
    email: (issue) =>
      `유효하지 않은 이메일: ${issue.received} 을(를) 받았습니다.`,
    emoji: (issue) =>
      `유효하지 않은 이모지: ${issue.received} 을(를) 받았습니다.`,
    endsWith: (issue) =>
    ...
    finite: (issue) =>
      `유효하지 않은 유한 숫자: ${issue.received} 을(를) 받았습니다.`,
    hash: (issue) => `유효하지 않은 해쉬: ${issue.received} 을(를) 받았습니다.`,
    hexColor: (issue) =>
      `유효하지 않은 hex 색상 코드: ${issue.received} 을(를) 받았습니다.`,
    hexadecimal: (issue) =>
    ...
    includes: (issue) =>
      `유효하지 않은 컨텐츠: ${issue.expected} 을(를) 예상했으나 ${issue.received} 을(를) 받았습니다.`,
    integer: (issue) =>
      `유효하지 않은 정수: ${issue.received} 을(를) 받았습니다.`,
    ...
    notValue: (issue) =>
      `유효하지 않은 값: ${issue.expected} 을(를) 예상했으나 ${issue.received} 을(를) 받았습니다.`,
    octal: (issue) =>
      `유효하지 않은 8진수: ${issue.received} 을(를) 받았습니다.`,
    regex: (issue) =>
