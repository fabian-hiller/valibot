...
const language: Language = {
  ...
  specific: {
    ...
    maxLength:      (issue) => `Taille invalide: attendu ${issue.expected}, mais reçu ${issue.received}`,
    ...
    minLength:      (issue) => `Taille invalide: attendu ${issue.expected}, mais reçu ${issue.received}`,
    ...
    notLength:      (issue) => `Taille invalide: attendu ${issue.expected}, mais reçu ${issue.received}`,
