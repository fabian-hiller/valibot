...
const language: Language = {
  ...
  specific: {
    ...
    endsWith:       (issue) => `Akhir tidak valid: Diharapkan ${issue.expected} tetapi menerima ${issue.received}`,
    ...
    hexadecimal:    (issue) => `Hexadecimal tidak valid: Menerima ${issue.received}`,
    ...
    integer:        (issue) => `Integer tidak valid: Menerima ${issue.received}`,
    ...
    isoDateTime:    (issue) => `Date-time tidak valid: Menerima ${issue.received}`,
    ...
    multipleOf:     (issue) => `Banyak tidak valid: Diharapkan ${issue.expected} tetapi menerima ${issue.received}`,
    ...
    octal:          (issue) => `Octal tidak valid: Menerima ${issue.received}`,
    ...
    startsWith:     (issue) => `Awal tidak valid: Diharapkan ${issue.expected} tetapi menerima ${issue.received}`,
