...
For example, to validate a simple login form, <a href="https://zod.dev/" target="_blank" rel="noreferrer">Zod</a> requires <a href="https://bundlejs.com/?q=zod&treeshake=%5B%7B+object%2Cstring+%7D%5D" target="_blank" rel="noreferrer">11.51 kB</a> whereas I requires only <a href="https://bundlejs.com/?q=valibot&treeshake=%5B%7B+email%2CminLength%2Cobject%2Cstring+%7D%5D" target="_blank" rel="noreferrer">0.7 kB</a>. That's a 94 % reduction in bundle size. This is due to the fact that Zod's functions have several methods with additional functionality that cannot be easily removed by current bundlers when they are not executed in your source code.
