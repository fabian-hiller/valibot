...
> We are aware that migrating large schemas can be annoying and time consuming. Therefore, we plan to release a codemode soon that will automate the following steps for you.
