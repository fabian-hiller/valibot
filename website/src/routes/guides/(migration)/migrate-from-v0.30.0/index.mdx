...
> There are already two codemods available from [Codemod](https://codemod.com/registry/valibot-0-30-0) and [Grit](https://github.com/fabian-hiller/valibot/pull/591) that will automate the following steps for you. Once we can confirm that they work as expected, we will include them in this guide.
