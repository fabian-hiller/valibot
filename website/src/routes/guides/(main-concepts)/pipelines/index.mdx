...
> Currently I break the pipeline immediately as soon as an error is thrown. Maybe this will change or become configurable. Read more in [this issue](https://github.com/fabian-hiller/valibot/issues/18).
