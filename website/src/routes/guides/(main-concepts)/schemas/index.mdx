...
Schema functions: <Link href="/api/bigint">`bigint`</Link>, <Link href="/api/boolean">`boolean`</Link>, <Link href="/api/null_">`null_`</Link>, <Link href="/api/number">`number`</Link>, <Link href="/api/string">`string`</Link>, <Link href="/api/symbol">`symbol`</Link>, <Link href="/api/undefinedType">`undefinedType`</Link>
...
Schema functions: <Link href="/api/any">`any`</Link>, <Link href="/api/enum_">`enum_`</Link>, <Link href="/api/instance">`instance`</Link>, <Link href="/api/intersect">`intersect`</Link>, <Link href="/api/nan">`nan`</Link>, <Link href="/api/never">`never`</Link>, <Link href="/api/nonNullable">`nonNullable`</Link>, <Link href="/api/nonNullish">`nonNullish`</Link>, <Link href="/api/nonOptional">`nonOptional`</Link>,<Link href="/api/nullable">`nullable`</Link>, <Link href="/api/nullish">`nullish`</Link>, <Link href="/api/optional">`optional`</Link>, <Link href="/api/picklist">`picklist`</Link>, <Link href="/api/recursive">`recursive`</Link>, <Link href="/api/special">`special`</Link>, <Link href="/api/union">`union`</Link>, <Link href="/api/unknown">`unknown`</Link>, <Link href="/api/variant">`variant`</Link>, <Link href="/api/voidType">`voidType`</Link>
