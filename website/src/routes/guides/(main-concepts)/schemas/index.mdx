...
Schema functions: <Link href="/api/bigint">`bigint`</Link>, <Link href="/api/boolean">`boolean`</Link>, <Link href="/api/null_">`null_`</Link>, <Link href="/api/number">`number`</Link>, <Link href="/api/string">`string`</Link>, <Link href="/api/symbol">`symbol`</Link>, <Link href="/api/undefined_">`undefined_`</Link>
