...
Schema methods: <Link href="/api/brand">`brand`</Link>, <Link href="/api/coerce">`coerce`</Link>, <Link href="/api/fallback">`fallback`</Link>, <Link href="/api/getDefault">`getDefault`</Link>, <Link href="/api/getDefaults">`getDefaults`</Link>, <Link href="/api/is">`is`</Link>, <Link href="/api/parse">`parse`</Link>, <Link href="/api/safeParse">`safeParse`</Link>, <Link href="/api/transform">`transform`</Link>, <Link href="/api/unwrap">`unwrap`</Link>
